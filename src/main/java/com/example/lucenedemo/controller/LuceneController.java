...
//    }
    ...
    public Long searchField(@RequestParam String queryString, @RequestParam String secondQueryString, @RequestParam String dateRange) {
        return luceneIndexService.searchField(queryString,secondQueryString,dateRange);
    }
